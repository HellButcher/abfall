...
fn main() {
    println!("=== VTable + Box Allocation Test: Proper Drop Semantics ===\n");
    ...
    {
        let ctx = GcContext::with_options(false, std::time::Duration::from_secs(10));
        ...
        drop(obj2);
        drop(obj3);
        println!("Dropped 2 GcPtr references");
    ...
    println!("✅ ALL TESTS PASSED - VTable + Box allocation works perfectly!");
